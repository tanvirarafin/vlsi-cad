module asmd_multiplier (VGND,
 ...
 sky130_fd_sc_hd__a22o_1 _152_ (.A1(\datapath_module0.multiplier[3] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_2 _153_ (.A(_130_),
    .X(_139_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dlymetal6s2s_1 _154_ (.A(_139_),
    .X(_030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a32o_1 _246_ (.A1(_103_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dlymetal6s2s_1 _247_ (.A(_139_),
    .X(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _270_ (.A(_127_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__nor2_1 _271_ (.A(net1),
 ...
 sky130_fd_sc_hd__dfrtp_4 _284_ (.D(\control_module0.next_state ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dfrtp_1 _285_ (.D(_032_),
    .Q(net11),
    .RESET_B(_012_),
    .CLK(clk),
    .VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dfrtp_1 _286_ (.D(_033_),
    .Q(net12),
    .RESET_B(_013_),
    .CLK(clk),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_4 _287_ (.D(_034_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dfrtp_1 _288_ (.D(_035_),
    .Q(net14),
    .RESET_B(_015_),
    .CLK(clk),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_4 _289_ (.D(_036_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dfrtp_1 _290_ (.D(_037_),
    .Q(net16),
    .RESET_B(_017_),
    .CLK(clk),
    .VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dfrtp_1 _291_ (.D(_038_),
    .Q(net17),
    .RESET_B(_018_),
    .CLK(clk),
    .VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dfrtp_1 _292_ (.D(_039_),
    .Q(net18),
    .RESET_B(_019_),
    .CLK(clk),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _294_ (.D(_041_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dfrtp_2 _295_ (.D(_042_),
 ...
 sky130_fd_sc_hd__dfrtp_2 _296_ (.D(_043_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dfrtp_4 _297_ (.D(_044_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dfrtp_2 _298_ (.D(_045_),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 input1 (.A(reset),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_1 input10 (.A(word1[3]),
    .X(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dlymetal6s2s_1 input2 (.A(start),
    .X(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_1 input3 (.A(word0[0]),
    .X(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_1 input4 (.A(word0[1]),
    .X(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_1 input5 (.A(word0[2]),
    .X(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dlymetal6s2s_1 input6 (.A(word0[3]),
    .X(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_1 input7 (.A(word1[0]),
    .X(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dlymetal6s2s_1 input8 (.A(word1[1]),
    .X(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dlymetal6s2s_1 input9 (.A(word1[2]),
    .X(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
